...
from services.display.tft_text import draw_text
...
class GameMenu:
    ...
    def render(self) -> np.ndarray:
        ...
        image[:] = (18, 8, 5)
        draw_text(image, "FC 游戏列表", (12, 7), 18, (80, 218, 255))
        cv2.line(image, (10, 34), (246, 34), (130, 90, 70), 1)

        if not self.roms:
            draw_text(image, "未找到 .NES 游戏", (12, 49), 16, (100, 100, 240))
        else:
            ...
            for row, rom in enumerate(self.roms[page_start:page_start + self.PAGE_SIZE]):
                ...
                draw_text(image, label, (12, y - 3), 15, color)

        draw_text(image, "方向键：选择   A：开始", (12, 213), 14, (170, 210, 130))
        return image
