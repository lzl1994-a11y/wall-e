...
# English: this module lives at services/action/, so parents[2] is the repository root.
# 中文：当前模块位于 services/action/，因此 parents[2] 才是仓库根目录。
ACTION_SKILL_REGISTRY_PATH = (
    Path(__file__).resolve().parents[2] / "core" / "action_skills.json"
)
