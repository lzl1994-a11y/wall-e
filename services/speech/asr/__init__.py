...
# English: ASR is nested below services/speech/asr; keep relative model paths rooted
# at the repository instead of accidentally resolving them below the service package.
# 中文：ASR 位于 services/speech/asr 三层目录下；相对模型路径必须以仓库为根，
# 避免分类后错误地从语音服务目录查找模型。
