...
def main():
    ...
    cmd = [
        ...
        "(cd /opt/tros/humble/lib/mono2d_body_detection && ros2 run mono2d_body_detection mono2d_body_detection --ros-args --log-level WARN -p is_shared_mem_sub:=0 -p ros_img_topic_name:=/image_nv12 -p ai_msg_pub_topic_name:=/hobot_mono2d_body_detection) & "
