...
def main():
    ...
    cmd = [
        ...
        f"{shlex.quote(ros_python)} {scaler_script} --ros-args --log-level WARN -p transform_mode:=none -p image_topic:=/image -p model_width:=960.0 -p model_height:=544.0 -p x_scale:=2.15 -p y_scale:=1.0 -p x_offset:=0.0 -p y_offset:=0.0 & "
